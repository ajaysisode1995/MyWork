...
public class ServerFactory implements AbstractComputerFactory{
	...
	public ServerFactory(String ram, String hdd, String cpu, boolean isGraphicEnable, boolean isBlutoothEnable) {
		super();
		this.ram = ram;
		this.hdd = hdd;
		this.cpu = cpu;
	...
	public Computer createComputer() {
		...
		return new Server(ram, hdd, cpu, isGraphicEnable, isBlutoothEnable);
	}
