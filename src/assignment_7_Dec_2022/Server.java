...
public class Server implements Computer{
	...
	public Server(String ram, String hdd, String cpu, boolean isGraphicEnable, boolean isBlutoothEnable) {
		super();
		this.ram = ram;
		this.hdd = hdd;
		this.cpu = cpu;
	...
	public boolean isGraphicEnable() {
		// TODO Auto-generated method stub
		return this.isGraphicEnable;
	}
	@Override
	public boolean isBlutoothEnable() {
		// TODO Auto-generated method stub
		return this.isBlutoothEnable;
	}

	@Override
	public String toString() {
		return "Server [ram=" + ram + ", hdd=" + hdd + ", cpu=" + cpu + ", isGraphicEnable=" + isGraphicEnable
